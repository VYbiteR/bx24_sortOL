...
> Для работы в Desktop-приложении с собственным доменом пока нет автоматизированного решения.  
> На текущий момент вариант только через обращение в техподдержку.
